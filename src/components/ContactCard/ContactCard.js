        ...
        <div className="flex flex-col gap-8">
            <div className="relative max-w-lg w-full">
                ...
                <div className="contact-card bg-white border flex flex-col h-auto sm:h-[250px] justify-between -translate-y-8 shadow-md z-10 py-6 py-8 md:py-10 px-8 md:px-13 lg:px-15 max-w-lg w-full">
                    <div className="">
                        <div className="font-display font-bold text-xl md:text-3xl mb-1">
                            {name}
                        </div>
                        <div className="font-display italic mb-4 text-xs xs:text-sm md:text-base">
                            {title}
                        </div>
                    </div>
                    ...
                    <div className="font-display text-md space-y-1">
                        <p className="font-secondary">
                            <span className="font-display font-bold text-sm xs:text-base">
                                Phone:
                            </span>{' '}
                            <a
