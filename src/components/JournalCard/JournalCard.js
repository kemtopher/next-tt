...
export const JournalCard = ({
  ...
  return (
    <div className="w-full h-full p-3 md:p-6 border flex gap-4 md:gap-8">
        <div className="h-full w-[125px]">
            <div className="h-full flex flex-col justify-center gap-4 font-secondary pr-6 border-r border-black">
        ...
        <div className="h-full w-full flex flex-col justify-between gap-4 lg:gap-8">
            ...
            <Link href={link} className="flex justify-end gap-2 hover:text-accent group">
